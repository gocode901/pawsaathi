...
import { faSearch, faCircleDot, faGreaterThan } from '@fortawesome/free-solid-svg-icons';
...
const Signup1 = () => {
  ...
  useEffect(() => {
    ...
    link.href = 'https://fonts.googleapis.com/css2?family=Baloo+2:wght@400;700&display=swap';
    link.rel = 'stylesheet';
    ...
    <div className="container">
      ...
      <div className="sign-up-form">
        ...
        <div className="form-group full-width">
          <input type="email" placeholder="Your Email ID" id="email" name="email" />
        </div>
        <div className="form-group">
          <label className="checkbox-label">
            <b>I am a </b><span className='span'>(select all that apply)</span>
          </label>
        ...
        <div className="step-indicator-container">
          ...
          <button type="submit" className="submit-button" onClick={handleNextClick}>
            Next <FontAwesomeIcon icon={faGreaterThan} style={{ color: "navy", marginLeft: "1rem" }} />
          </button>
        </div>
      </div>
    </div>
